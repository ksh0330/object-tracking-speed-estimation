...
class VideoMonitor(QWidget):
    def __init__(self, video_source):
        ...
        sourceA = np.array([[668, 110], [780, 121], [52, 485], [291, 561]])
...
if __name__ == "__main__":
    ...
    video_source = r"D:\DCU_up_10.mp4" # 웹캠은 주소 대신 그냥 0으로 바꿔주면 됨
