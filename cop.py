...
class VideoMonitor(QWidget):
    def __init__(self, video_source):
        ...
        self.current_frame_time = time.time()  # 각 프레임 처리 시간 기록
        self.previous_frame_time = None  # 이전 프레임의 시간
        self.start_time = None  # 객체가 영역에 진입한 시간
        self.out_time = None  # 객체가 영역을 벗어날 때 시간
        ...
        self.model = YOLO("yolov8s.pt").to(self.device) #객체 인식 YOLO 상용 모델

        # Areas and colors
        self.areas = {
            "A": [(635, 200), (480, 490), (904, 489), (735, 199)]
        }
        self.RED, self.BLACK, self.WHITE, self.BLUE, self.GREEN = (0, 0, 255), (0, 0, 0), (255, 255, 255), (255, 0, 0), (0, 255, 0)
        self.T_W, self.T_H = 5, 50
        ...
        self.frame_duration = 1 / self.fps  # 한 프레임당 재생 시간 (초)
        ...
        self.timer.start(int(self.frame_duration * 1000))  # ms로 변환
        ...
        sourceA = np.array([[635, 200], [735, 199], [480, 490], [904, 489]])
    ...
    def update_frame(self):
        ...
        if ret:
            ...
            elapse_time = current_time - self.last_frame_time
            #print(self.frame_duration)

            if elapse_time >= self.frame_duration:
                # YOLO 모델을 통해 객체 추적
                ...
                time.sleep(self.frame_duration - elapse_time)  # 부족한 시간을 대기
        else:
            self.cap.release()
            ...
            for box, box_C, track_id, name, conf in zip(boxes, boxes_C, track_ids, names, confs):
                ...
                if self.show_bbox:
                    ...
                    if in_A and cls_name == 'car':
                        ...
                        cv.putText(frame, f'ID: {int(track_id)} {cls_name} {self.av} km/h',
                        ...
                        if track_id not in self.active_tracks['A']:
                        ...
                        if self.out_time is None:
                            ...
                            print(self.out_time)
                            t = self.out_time - self.start_time
                            print(t)
                            v = (50/t)*3.6
                            print(v)
...
if __name__ == "__main__":
    ...
    video_source = r"D:\REAL\cop_30.mp4" # 웹캠은 주소 대신 그냥 0으로 바꿔주면 됨
