...
class VideoMonitor(QWidget):
    def __init__(self, video_source):
        ...
        # Areas and colors
        self.areas = {
            "B": [(433, 681), (851, 274), (791, 269), (250, 641)],
            "A": [(821, 244), (147, 551), (298, 587), (881, 248)]
        }
        ...
        sourceA = np.array([[821, 244], [881, 248], [147, 551], [298, 587]])
        sourceB = np.array([[433, 681], [250, 641], [851, 274], [791, 269]])
...
if __name__ == "__main__":
    ...
    video_source = r"D:\10.mp4" # 웹캠은 주소 대신 그냥 0으로 바꿔주면 됨
